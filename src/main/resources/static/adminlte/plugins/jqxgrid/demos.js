...
function getDemoTheme() {
    ...
    var url = "/adminlte/plugins/jqxgrid/jqwidgets/styles/jqx." + theme + '.css';
    if (theme === "light" || theme === "dark") {
		...
		{
			  url = "/adminlte/plugins/jqxgrid/jqwidgets/styles/jqx." + theme + '-ie.css';
		}
	}
	if (window.location.href.toString().indexOf("angularjs") >= 0) {
        var loc = window.location.href.toString();
        url = "/adminlte/plugins/jqxgrid/jqwidgets/styles/jqx." + theme + '.css';
